  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        months: cn(
          "flex flex-col gap-4 md:flex-row relative",
          defaultClassNames.months
        ),
        month: cn("flex w-full flex-col gap-4", defaultClassNames.month),
        nav: cn(
          "flex w-full absolute top-0 inset-x-0 items-center justify-between gap-1",
        ...
        dropdown_root: cn(
          "relative has-focus:border-ring has-focus:ring-ring/50 has-focus:ring-[3px] rounded-md border border-input shadow-xs",
