...
- _Ejemplo: En una universidad existen becarios que deben registrar sus horas de trabajo. Actualmente este control es fundamental para la gestión administrativa y para justificar los pagos._
...
- _Ejemplo: Desde aplicaciones simples de contabilización de tiempo hasta módulos de control horario integrados en ERPs corporativos._
...
- _Ejemplo: Las soluciones comerciales son demasiado costosas para implementar, no se adaptan a las particularidades del sistema de becas de la universidad, o no integran con los sistemas administrativos existentes._
...
- _Ejemplo: Se propone desarrollar una aplicación web específica para el control horario de becarios que se integre con los sistemas administrativos de la universidad._
